            ...
            <div className="service-container-wrapper style3  section-padding fix">
                ...
                <div className="container">
                    <div className="service-wrapper style3">
                        <h2 className="wow fadeInUp animate__animated  animate__fadeInLeft animate__delay-1s " data-wow-delay=".3s">Join our team to revolutionize women's urban mobility.</h2>
                        <p className="text wow fadeInUp animate__animated  animate__fadeInLeft animate__delay-2s " data-wow-delay=".5s">At RIDY, we're creating innovative ride-sharing solutions that prioritize safety, 
                        ...
                        <Link href="/contact"> <span className="theme-btn wow fadeInUp animate__animated  animate__fadeInLeft animate__delay-3s" data-wow-delay=".3s"> Join Our Team
