...
const About5 = ({ subtitle, box4, boximg4, mtop,title, subTitle, content, none, boximg1, boxtitle1, boxcontent4, boxcontent1, boximg2, boxtitle2, boxcontent2, boxtitle3, boxcontent3, boximg3, img1, btnurl, btnname }) => {
    return (
                                ...
                                <div className="col-xl-6 order-xl-1">
                                    ...
                                    <div className="fancy-box animate__animated  animate__fadeInRight  style3 mb-20 wow fadeInUp" data-wow-delay=".2s">
                                        ...
                                        <div className="fancy-box animate__animated  animate__fadeInRight animate__delay-4s style3  wow fadeInUp" data-wow-delay=".2s">
                                            <div className="icon mb-20">
                                            <img style={{ display: `${none}` }} src={boximg4} alt="img" width={50} height={50} />
                                            </div>
                                            <div className="content">
                                                <h4>{box4} </h4>
